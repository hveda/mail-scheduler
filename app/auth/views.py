...
from app.auth.forms import LoginForm, PasswordChangeForm, RegistrationForm, UserEditForm
...
class LoginView(MethodView):
    ...
    def post(self):
        ...
        if form.validate_on_submit():
            ...
            # Normalize the path to prevent bypasses through encoding or
...
class RegisterView(MethodView):
    ...
    def post(self):
        ...
        if form.validate_on_submit():
            ...
            user.password = form.password.data or ""
...
class UserEditView(MethodView):
    ...
    def get(self, user_id):
        ...
        return render_template(
            "auth/edit_user.html", form=form, user=user, title="Edit User"
        )
