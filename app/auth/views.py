...
blueprint.add_url_rule('/users/<int:user_id>/edit', view_func=edit_user_view, methods=['GET', 'POST'])
blueprint.add_url_rule('/change-password', view_func=change_password_view, methods=['GET', 'POST'])
